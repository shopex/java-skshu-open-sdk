...
public class ShopexOpenPostTestHttps {
    ...
    public static void main(String[] args) {
        ...
        ordersJsonObject.put("productName", "ZGD6026+三棵树砖石漆专用底漆+1KG*4/件+A2100");

        JSONObject jsonDataObject = new JSONObject();
        jsonDataObject.put("orders", ordersJsonObject.toJSONString());

        Map<String, String> appParams = new HashMap<String, String>();
        appParams.put("jsondata", jsonDataObject.toJSONString());
